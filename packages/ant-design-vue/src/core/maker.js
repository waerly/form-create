...
function useAlias(maker) {
    ['treeSelect', 'upload', 'siUpload', 'siImageUpload', 'siRichEditor2', 'siUserPicker', 'frame', 'autoComplete', 'suggestSearch', 'cascader', 'datePicker', 'frame', 'inputNumber',  'inputPassword', 'radio', 'rate', 'switch', 'rate', 'slider', 'timePicker', 'siSlot', 'slotContainer', 'formula', 'title', 'demo', 'relation', 'relationForm', 'relationTable'].reduce((maker, name) => {
