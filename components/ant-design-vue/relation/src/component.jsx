...
export default defineComponent({
    ...
    computed: {
        ...
        currentSlotName() {
            return this.slotName || this.injectField || 'relation';
        },
        tableColumns() {
    ...
    methods: {
        ...
        renderDefault() {
            if (!this.columns.length) {
                return (
                    <div class="_fc-relation-empty">
                        <AEmpty description={this.emptyText}/>
                        {!this.readonlyState ? (
                            <div class="_fc-relation-empty-hint">
            ...
            return (
                <div class="_fc-relation-table">
                    {this.showToolbar ? (
                        <div class="_fc-relation-toolbar">
                            <ASpace>
        ...
        renderBoundPlaceholder() {
            ...
            return (
                <div class="_fc-relation-designer">
    ...
    render() {
        ...
        return (
            <div class={['_fc-relation', {'_fc-relation-preview': this.readonlyState}]}>
                {slot
